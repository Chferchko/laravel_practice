	...
	<form class="row g-3" action="{{ route('post.store') }}" method="POST">
		...
		<div class="form-group col-md-6">
			...
			<input name="title" type="text" class="form-control @error('title') is-invalid @enderror"
				id="title" placeholder="Придумайте заголовок..." value="{{ old('title') }}">
		...
		<div class="form-group col-md-6">
			...
			<input name="image" type="text" class="form-control @error('image') is-invalid @enderror"
				id="image" placeholder="Укажите ссылку на изображение..." value="{{ old('image') }}">
		...
		<div class="form-group col-md-6">
			...
			<input name="description" type="text" class="form-control @error('description') is-invalid @enderror"
				id="description" placeholder="Коротко..." value="{{ old('description') }}">
		...
		<div class="form-group col-12">
			...
			<textarea name="content" class="form-control @error('content') is-invalid @enderror overflow-hidden"
				id="content" placeholder="Пишите..." value="{{ old('content') }}"></textarea>
